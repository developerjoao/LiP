/**
* @file  monster.h
* @brief Definicao de prototipos da classe monster.
*/
#ifndef __MONSTER__
#define __MONSTER__
...
* @brief   Classe que representa um monstro.
* @details Monstros lutarão contra o personagem, logo possuirão atributos semelhantes ao do personagem.
*/
class Monster {
  public:
